...
![Port Forwarding list](https://raw.githubusercontent.com/ondrab1/headlamp-port-forwards/v0.1.0/docs/port-forwarding-list.png)
...
![Plugin settings](https://raw.githubusercontent.com/ondrab1/headlamp-port-forwards/v0.1.0/docs/plugin-settings.png)
